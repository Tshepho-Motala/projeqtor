...
if ($profile->profileCode!='ADM') {
	echo 'Call to uninstallPlugin.php for non Admin user.<br/>This action and your IP has been traced.';
	traceHack('Call to uninstallPlugin.php for non Admin user');
	exit;
}
